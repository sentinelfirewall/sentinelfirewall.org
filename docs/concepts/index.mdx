...
wasmCloud can stand alone *or* run on Kubernetes with the [**wasmCloud Kubernetes operator**](https://github.com/wasmCloud/wasmcloud-operator). Moreover, wasmCloud is designed to integrate with existing cloud native tooling and standards such as OpenTelemetry and Open Policy Agent.
:::
