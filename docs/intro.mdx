...
Sentinel is a fork of [ConfigServer Firewall & Security](https://sentinelfirewall.org/redirect?to=https://web.archive.org/web/20250426002531/https://configserver.com/configserver-security-and-firewall/)
...
* Actively patch, improve, and adapt it to modern needs (ipsets to nfset, iptables to nftables..)
