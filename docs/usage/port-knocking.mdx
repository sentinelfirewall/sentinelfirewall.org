...
For more information on the idea of port knocking see: [https://wiki.archlinux.org/title/Port_knocking](https://wiki.archlinux.org/title/Port_knocking)
...
More information about the ipt_recent module can be found in the iptables man page and at [https://www.snowman.net/projects/ipt_recent/](https://www.snowman.net/projects/ipt_recent/)
