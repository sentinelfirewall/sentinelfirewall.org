...
Below are the contents of `csf.pl` for your verification.

```bash
#!/usr/bin/perl
###############################################################################
# Copyright (C) 2025 ConfigServer Project (https://github.com/sentinelfirewall/sentinel)
...
sub doupdate {
	...
	if ($input{command} eq "-uf") {
		...
		my $url = "https://raw.githubusercontent.com/sentinelfirewall/sentinel/refs/heads/main/csf/version.txt";
		if ($config{URLGET} == 1) {$url = "http://raw.githubusercontent.com/sentinelfirewall/sentinel/refs/heads/main/csf/version.txt";}
	...
	if ((($actv ne "") and ($actv =~ /^[\d\.]*$/)) or $force) {
		if (($actv > $version) or $force) {
			...
			my $url = "https://raw.githubusercontent.com/sentinelfirewall/sentinel/refs/heads/main/csf.tgz";
			if ($config{URLGET} == 1) {$url = "http://raw.githubusercontent.com/sentinelfirewall/sentinel/refs/heads/main/csf.tgz";}
			...
			if (! -z "/usr/src/csf/csf.tgz") {
				...
				ConfigServer::Service::restartlfd();
				print "\n...All done.\n\nChangelog: https://raw.githubusercontent.com/sentinelfirewall/sentinel/refs/heads/main/csf/changelog.txt\n";
			}
		} else {
